# Generated by Django 4.1.5 on 2023-03-06 18:02
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('dname', models.CharField(default='Everyone', max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Post',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('post', models.CharField(default='Everyone', max_length=100, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='Schedule',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('basic_pay_rate', models.DecimalField(decimal_places=2, default=10000, max_digits=8)),
                ('overtime_pay_rate', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('hours_worked', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('deductions', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('net_pay', models.DecimalField(decimal_places=2, max_digits=8, null=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
